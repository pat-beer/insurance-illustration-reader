...
- **อ่านเอกสาร .docx อัตโนมัติ** — ตรวจจับ SV/DB, Guaranteed/Non-Guaranteed, Account Value ด้วย keyword matching (ไม่ hardcode ต่อสินค้า) รวมตาราง UL สองฐาน (Guaranteed Basis / Current Assumed Basis) เช่น SunRise
...
**PDF import** — เอกสารบางฉบับ (เช่น SunRise) มาเป็น PDF ไม่ใช่ .docx ต้องใช้ pipeline คนละชุด (เช่น pdf.js ดึงข้อความ+ตำแหน่ง แล้วประกอบตารางเอง เพราะ PDF ไม่มีโครงสร้างตารางแบบ mammoth.js) — เป็นงานใหญ่แยกต่างหาก ตอนนี้ยังรับเฉพาะ .docx
